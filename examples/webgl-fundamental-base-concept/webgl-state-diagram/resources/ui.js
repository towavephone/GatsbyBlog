...
import { addElem, flash, helpToMarkdown, px, replaceParams, updateElem } from './utils.js';
...
export function showHint(e) {
  if (e.target.nodeName === 'A' || (e.type !== 'click' && !showHintOnHover)) {
    return;
  }
  e.preventDefault();
  e.stopPropagation();
