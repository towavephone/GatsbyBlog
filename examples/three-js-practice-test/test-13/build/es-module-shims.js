...
(function() {
        ...
        if (self._esmsi) {
          ...
          reject(
            (!(_err instanceof Event) && _err) ||
              (err && err.error) ||
              new Error(`Error loading or executing the graph of ${errUrl} (check the console for ${src}).`)
          );
          err = undefined;
        }
      }
  ...
  const supportsDynamicImportCheck = dynamicImportScript(createBlob('export default u=>import(u)')).then(
    (_dynamicImport) => {
      ...
      (r = new ArrayBuffer(4 * i)),
        (e = (function(e, r, a) {
                  ...
                  r: do {
                    switch (s[r >> 1] | 0) {
                      ...
                      case 41: {
                        ...
                        e = t[11] | 0;
                        if (
                          (e | 0) != 0 ? (t[(e + 20) >> 2] | 0) == (t[((t[17] | 0) + ((f & 65535) << 2)) >> 2] | 0) : 0
                        ) {
                          r = (e + 4) | 0;
                          if (!(t[r >> 2] | 0)) t[r >> 2] = a;
                          t[(e + 12) >> 2] = a;
                          ...
                          default: {
                            ...
                            a: do {
                              if (!(x(a) | 0)) {
                                ...
                                e = c[292] | 0;
                                if (!(y(t[((t[17] | 0) + (e << 2)) >> 2] | 0) | 0) ? (i[(b + e) >> 0] | 0) == 0 : 0)
                                  f = 68;
                                else f = 71;
                              } else
                                switch ((a << 16) >> 16) {
          ...
          function K(e, r, a, i) {
            ...
            a = a | 0;
            i = i | 0;
            if ((s[(e + 4) >> 1] | 0) == (i << 16) >> 16 ? (s[(e + 2) >> 1] | 0) == (a << 16) >> 16 : 0)
              r = (s[e >> 1] | 0) == (r << 16) >> 16;
            else r = 0;
            return r | 0;
          }
      ...
      for (const { s: start, se: end, d: dynamicImportIndex } of imports) {
        ...
        if (dynamicImportIndex === -1) {
          ...
          // circular shell execution
            ...
            resolvedSource += `${source.slice(lastIndex, start - 1)}/*${source.slice(start - 1, end)}*/${urlJsString(
              blobUrl
