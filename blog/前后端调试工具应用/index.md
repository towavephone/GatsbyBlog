...
[Flask 调试项目 Demo](https://github.com/towavephone/flask-debugger-demo)

### 疑难点

1. 接口并发高的情况下 flask_profiler 不可用，因为底层是 sqlite 不支持高并发写，可能要迁移到别的数据库，也可以屏蔽此插件
2. flask-debugtoolbar 只能查看请求下的 mongodb 数据库访问记录，针对 sqlalchemy 的访问记录还需另外实现

### 效果

![](res/2025-08-06-13-55-54.png)

![](res/2025-08-06-13-56-19.png)
